...
| `reviews/` | 历史评审与分析快照：`V2_REVIEW` / `DEEP_REVIEW_2026_07_14` / `ARCHITECTURE_ANALYSIS_REPORT` / `PHASE5B_ANALYSIS` / `PUBLICATION_READINESS` / `NEEDLE_FIX`（needle harness 修复记录）/ `VISUALIZATION_COMPLETE` |
